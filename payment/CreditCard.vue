...
import CardExpiry from './stripe/CardExpiry'
import CardCvc from './stripe/CardCvc'
import CardNumber from './stripe/CardNumber'
import { Stripe } from './stripe/stripeElements'
export default {
  data(){
    return {
      user: AUTH.user,
